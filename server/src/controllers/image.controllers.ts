...
const createImage = async (req: IGetUserAuthInfoRequest, res: Response) => {
    try {
...
const getImages = async (req: IGetUserAuthInfoRequest, res: Response) => {
    try {
...
const getImageByID = async (req: IGetUserAuthInfoRequest, res: Response) => {
    try {
...
const getImagesByPostID = async (req: IGetUserAuthInfoRequest, res: Response) => {
    try {
...
const updateImageByID = async (req: IGetUserAuthInfoRequest, res: Response) => {
    try {
        const { image_id } = req.params;
...
const deleteImageByID = async (req: IGetUserAuthInfoRequest, res: Response) => {
    try {
        const { image_id } = req.params;
...
export { createImage, getImages, getImageByID, getImagesByPostID, updateImageByID, deleteImageByID };
