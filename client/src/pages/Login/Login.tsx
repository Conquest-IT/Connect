    ...
    return (
        <div className='w-screen h-screen flex flex-row '>
            ...
            <div className='flex-1 bg-slate-100 w-full flex flex-col justify-center items-center'>
                <span className='text-xl  text-emerald-500 mb-6'>You're back! Log in to enteract with others.</span>
                <form className='w-1/2 flex flex-col space-y-2'>
                    ...
                    <button className='bg-emerald-500 hover:bg-emerald-700 transition ease-in-out text-white rounded-md p-2 '>Login</button>
                </form>
            </div>
        </div>
    )
